...
const Chat = () => {
  ...
  const onShowCitation = (citation: Citation) => {
    ...
    if (citation.url) {
      citation.url = citation.url.replace("stvitalitygl375479395588.blob.core.windows.net/athena-uk-blob-container", "vitality-athena-uk-1.azurewebsites.net/specifications")
    }
